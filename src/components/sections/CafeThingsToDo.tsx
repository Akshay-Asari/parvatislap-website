...
const treks: Trek[] = [
  {
    ...
    image: "/images/Trek/PinParvatiPass.jpg",
  },
  {
    id: "jiwa-nala-trek",
    ...
    image: "/images/Trek/JiwaNala.jpg",
  },
  {
  ...
  },
  {
    ...
    image: "/images/Trek/BhandakThach.jpg",
  },
  {
    ...
    image: "/images/Trek/SwajaniBiskeri.jpg",
  },
  {
    id: "kheerganga-trek",
...
export default function CafeThingsToDo() {
  ...
  return (
    <>
      <section id="cafe-things" className="bg-primary py-24 px-6 [@media(min-width:2560px)]:py-24 [@media(min-width:2560px)]:px-48">
